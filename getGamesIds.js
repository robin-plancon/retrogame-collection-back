...
// List of the platforms ids that we want to retrieve games from
  ...
  for (let offset = 0; offset < 400000; offset += 500) {
    try {
      const result = await axios({
        ...
        data: `fields id; sort id desc; where (release_dates.platform = (${platform_list}) & (release_dates.status != (1,2,3,5) | release_dates.status = null)) & keywords != (16696, 24124, 2004, 38055, 37841, 5340, 305); limit 500; offset ${offset};`,
      });
